...
# Purpose: Read audio samples from an I2S microphone and write to SD memory card
...
# changing 'state' will affect recording to audio file
...
state = PAUSE
time.sleep(2)
print("resuming recording for 5")
state = RESUME
time.sleep(5)
