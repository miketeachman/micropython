...
#define I2S_GPIO_MAP \
    { \
        I2S_GPIO(1, MCK, RXTX, GPIO_08, IOMUXC_GPIO_08_SAI1_MCLK),  \
        ...
        I2S_GPIO(1, SCK, RXTX, GPIO_06, IOMUXC_GPIO_06_SAI1_TX_BCLK),  \
        I2S_GPIO(1, WS, RXTX, GPIO_07, IOMUXC_GPIO_07_SAI1_TX_SYNC),  \
